...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ConfirmTipService = __webpack_require__(1);
	...
	var TestComponent = React.createClass({
	  ...
	  onConfirm: function onConfirm(ev) {
	    var tip = new _ConfirmTipService.ConfirmTip(function () {
	      setTimeout(function () {
	        alert('完成');
	        tip.hide();
	      }, 2000);
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        'button',
	        { className: 'btn btn-primary', onClick: this.onConfirm },
	        '确认提示'
	      )
	    );
	  }
	...
	ReactDOM.render(React.createElement(TestComponent, null), document.body.appendChild(document.createElement('div')));
	    ...
	    value: function createElement() {
	      return React.createClass({
	        ...
	        onConfirmClick: function onConfirmClick() {
	          ...
	          this.props.onConfirm.call(this.props.self, function () {
	            _this.setState({
	              showLoading: false
	            });
	          });
	        ...
	        render: function render() {
	          ...
	          return React.createElement(
	            ...
	            React.createElement(
	              'div',
	              { style: showLoading ? { display: "none" } : { display: "flex", alignItems: "center", justifyContent: "center", height: "64px" } },
	              React.createElement(
	                'button',
	                {
	            ...
	            React.createElement(
	              'div',
	              { style: showLoading ? { display: "flex", alignItems: "center", justifyContent: "center", height: "64px" } : { display: "none" } },
	              React.createElement('img', { src: 'dist/img/loading.gif', alt: '' })
	            )
	          );
	        }
	      });
